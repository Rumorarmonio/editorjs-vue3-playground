...
Следующий шаг: провести keyboard-аудит editor и preview страниц, зафиксировать проблемные controls и начать с focus states / tab-order для shell actions и custom field wrappers.
