...
Следующий шаг: реализовать минимальный helper для создания и уничтожения одного nested Editor.js instance внутри `SectionIntro` field без общей rich field system.
