...
- Проект переведён к этапу Masks: ближайший фокус — определить, есть ли в текущих plain fields реальные phone/date/email/slug-like сценарии для масок и нужна ли зависимость `imask`.
...
Следующий шаг: проанализировать текущие plain fields и custom blocks на предмет реально нужных masks, затем решить, требуется ли `imask` на текущем этапе.
