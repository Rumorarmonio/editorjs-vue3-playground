...
Следующий шаг: вручную проверить language dropdown на editor/preview страницах, включая `Auto`, `RU`, `EN`, `ES`, сохранение preference в `localStorage` и пересоздание Editor.js при смене фактической локали.
