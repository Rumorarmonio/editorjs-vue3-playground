...
- Новый выбранный scope: реализовать базовые Block Tunes перед переходом к plain field system и custom blocks.
...
Следующий крупный шаг: реализовать базовые Block Tunes (`AnchorTune`, `SpacingTune`, `LabelTune`) по активному плану в `PLAN.md`.
