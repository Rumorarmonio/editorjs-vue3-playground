...
- Активный scope по `SPEC.md`: custom inline tools; ближайшая задача — реализовать text color inline tool поверх стабильных стандартных inline tools, renderer sanitizer и nested/rich editor scenarios.
...
Следующий шаг: проанализировать текущую inline tools конфигурацию, sanitizer и rich/nested editor подключение перед реализацией text color inline tool.
