...
Следующий шаг: вручную проверить preview sidebar в режимах `По заголовкам` и `По якорям и меткам`, language dropdown, block reveal animations и embed Fancybox/inline modes после `Reset draft`.
