...
- Активный scope по `SPEC.md`: Валидация после завершения Import JSON.
...
Следующий шаг: проанализировать текущие plain/rich field APIs и места сохранения данных, затем спроектировать минимальный validation result contract.
