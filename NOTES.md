...
Следующий шаг: вручную проверить preview sidebar в режимах `По заголовкам` и `По якорям и меткам` после `Reset draft`, а также language dropdown на editor/preview страницах.
