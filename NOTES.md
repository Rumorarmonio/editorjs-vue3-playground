...
- Следующий активный scope по `SPEC.md`: Plain field system для будущих custom blocks.
...
- Для этапа Plain field system нужно решить, достаточно ли внутреннего DOM helper API без видимого demo block или нужен небольшой usage harness для проверки удобства будущих custom tools.
...
Следующий шаг: реализовать минимальную reusable Plain field system в `editor/admin/fields` по плану активного этапа.
