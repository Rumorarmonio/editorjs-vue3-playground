...
Следующий шаг: вручную проверить preview sidebar в режимах `По заголовкам` и `По якорям и меткам`, language dropdown и block reveal animations после `Reset draft`.
