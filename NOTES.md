...
- Открытый вопрос активного accessibility-этапа: после Table Tool keyboard patch нужно вручную проверить, что tab stops на add-column / add-row / текущие floating row-column tune controls доступны и не ломают дефолтную навигацию по ячейкам.
