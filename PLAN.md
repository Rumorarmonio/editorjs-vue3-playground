...
Следующий крупный этап: реализовать editor shell и preview shell, подключить источник данных с приоритетом `localStorage` draft -> `content/default-page.json`, не переходя пока к стандартным Editor.js tools.
